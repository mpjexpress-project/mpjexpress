...
public class Iscatter {
  ...
  public Iscatter(String[] args) throws Exception {
	...
	for (i = 0; i < size; i++) {
	    ...
	    for (ns = 0; ns < iterations; ns++) {
			  ...
			  startwtime = MPI.Wtime();					
      		  ...
      		  req = MPI.COMM_WORLD.Iscatter(A,0,localsize,MPI.BYTE,B,0,localsize,MPI.BYTE,0);//last one is the root	
      		  req.Wait();
    ...
    MPI.Finalize();    
    if(my_pe == 0) {
      System.out.println("Iscatter TEST COMPLETE");	    
    }
  }
}
