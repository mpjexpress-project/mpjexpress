...
/**
 * This example application, is to check and demonstrat the functonality of contiguous datatypes. I'm writing an MPJ program by coverting a C program by Forest Hoffman at following URL
        ...
        suite.addTest(new ContiguousTest("simple add") {
		    ...
		    try { 
			    testSimplePackUnpack();
                             ...
                             e.printStackTrace();
			     fail("exception throw while calling testSimplePackUnpack method: " + e.getMessage());
		    }
            }
	}
 );
