...
public class JGFiBarrierBench implements JGFSection1{
  ...
  public JGFiBarrierBench(int rank, int nprocess) {
	this.rank = rank;    
...
/* Print the timing information */
  ...
  public static void main(String[] argv) throws Exception{
    JGFiBarrierBench p150 = new JGFiBarrierBench(argv);

  }

  public JGFiBarrierBench(String[] argv) throws Exception {
...
/* Initialise MPI */
     ...
     JGFiBarrierBench ba = new JGFiBarrierBench(rank, nprocess);
     ba.JGFrun();
