...
public class BufferTest2 {
  ...
  public BufferTest2(String args[]) throws Exception {
    ...
    if (MPJDev.WORLD.id() == 0) {
      ...
      Buffer buffer = new
	      Buffer( BufferFactory.create (weirdSize + SEND_OVERHEAD), 
			     SEND_OVERHEAD, weirdSize + SEND_OVERHEAD) ;
      ...
      Buffer buffer = new Buffer( BufferFactory.create 
		      (weirdSize+RECV_OVERHEAD), 
		      RECV_OVERHEAD , weirdSize+RECV_OVERHEAD ) ;
